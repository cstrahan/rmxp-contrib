= About
This is an assortment of libraries that I find usefull when working with RMXP (RPG Maker XP). The primary motivation in collecting these libraries has been to provide yaml and json support within RMXP. Because it was such a pain providing the YAML and JSON dependancies (considering RMXP requires pure Ruby libs), I figured I'd share these libraries to anyone interested.
